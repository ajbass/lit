...
Note that our package requires `gfortran` to be installed. If you run into issues with `gfortran`, see the answer [here](https://stackoverflow.com/questions/69639782/installing-gfortran-on-macbook-with-apple-m1-chip-for-use-in-r) for additional details. 
